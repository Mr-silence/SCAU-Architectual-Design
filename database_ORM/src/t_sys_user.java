...
public class t_sys_user implements Data_Adapter_Layer{
    ...
    public boolean Modify(t_sys_user user) {
        ...
        try (Connection connection = getConnection();
            ...
            preparedStatement.setString(12, user.getFAddress());
            preparedStatement.setString(13, user.getFRemark());
            preparedStatement.setTimestamp(14, user.getFLastLoginTime() != null ? new Timestamp(user.getFLastLoginTime().getTime()) : null);
